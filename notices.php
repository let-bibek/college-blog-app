...
$query = "SELECT * from blog_categories where id=8";
...
<body>
	...
	<section class="main-content-w3layouts-agileits">
		<div class="container">
			<h3 class="tittle"><strong class="text-center"> School of Engineering Notices</strong></h3>
			<div class="row inner-sec">
				...
				<aside class="col-lg-4 agileits-w3ls-right-blog-con text-right">
					<div class="right-blog-info text-left">
						...
						<ul class="list-group single" data-aos="zoom-in">
							<?php countcategories(); ?>
						</ul>
