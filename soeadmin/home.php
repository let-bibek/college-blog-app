		...
		foreach($tg as $tn => $tgroup){
			...
			?>
				...
				<?php if($multiple_groups && $current_group != $tgroup){ /* grouping, begin group & row */ ?>
					...
					<a class="btn btn-warning btn-block btn-lg collapser vspacer-lg" data-toggle="collapse" href="#group-<?php echo md5($tgroup); ?>"><?php echo $tgroup; ?> <i class="glyphicon glyphicon-chevron-right"></i></a>
