  ...
  <div id="wrapper">
      ...
      <div class="collapse navbar-collapse navbar-ex1-collapse">
        <ul class="nav navbar-nav side-nav">
          ...
          if ($usernow == "admin") {
            ...
            <li><a href="editors_choice_view.php"><i class="fa fa-trophy"></i>Trending posts choice</a></li>
    ...
    <div id="page-wrapper">
      <div class="row">
        <div class="col-lg-12">
          <ol class="breadcrumb">
            <li><a href="../index.php" style="text-decoration:none;"><i class="icon-dashboard"></i> <strong>View Website</strong></a></li>
            <li><i class="icon-dashboard" style="text-decoration:none;"></i> <strong>Dashboard</strong></li>
          </ol>
        </div>
      </div><!-- /.row -->
