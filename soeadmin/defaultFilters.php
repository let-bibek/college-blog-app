...
<?php
	...
	if(getLoggedAdmin()){
		...
		foreach($plugins as $pl){
			if($pl['title'] == 'Search') $spm_installed = true;
		}

		if(!$spm_installed) echo Notification::show(array(
			'message' => '<i class="glyphicon glyphicon-info-sign"></i> <a href="#"  class="alert-link"><i class="glyphicon glyphicon-hand-right"></i> Click here</a>.',
			'dismiss_days' => 30,
			'class' => 'success',
			'id' => 'spm_notification'
		));
