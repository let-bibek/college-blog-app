...
<?php if(!$noSignup){ ?>
	<div class="row my-5" style=" width:100%;height:100vh;display:grid;place-items:center;background-image:url(../images/pokharauniversity-3.jpg) ;background-size:cover;background-position:center; background-repeat:no-repeat;">
		...
		<div class="col-sm-8 col-md-6 col-lg-4">
			<div class="panel panel-primary">
				...
				<div class="panel-heading">
					<h1 class="panel-title"><strong>Sign Up Now</strong></h1>
				</div>
				...
				<div class="panel-body">
					<form method="post" action="membership_signup.php">
						<div class="form-group">
							...
							<input class="form-control" type="text" required="" placeholder="<?php echo $Translation['username']; ?>" id="username" name="newUsername">
