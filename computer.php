			...
			<div class="row inner-sec">
				...
				<div class="col-lg-8 image-title-container-about-us">
					<div class="blog-grid-top">
						...
						<p class="soe-about-description"><?php getdetaileddescriptioncomputer("titles"); ?></p>
					</div>
				</div>
			</div>
		</div>
				...
				<div class="address row">
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-8 address-right text-left">
								<h6>Address</h6>
								<p> <?php getcontactscomputer("titles", "1"); ?>
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-8 address-right text-left">
								<h6>Email</h6>
								<p>
									<a href="mailto:<?php getcontactscomputer("titles", "2"); ?>"><?php getcontactscomputer("titles", "2"); ?></a>
								</p>
							</div>
					...
					<div class="col-lg-4 address-grid">
						<div class="row address-info">
							...
							<div class="col-md-8 address-right text-left">
								<h6>Telephone</h6>
								<p><?php getcontactscomputer("titles", "3"); ?></p>
